...
# Make color palette
gmt makecpt -Ccyclic.cpt -V -T1/12598/250 > colors.cpt

# Make raster image
gmt grdimage st_sed.nc -Ccolors.cpt -R90/130/-20/10 -JM6i -P -I+a15+ne0.75 -Xc -K > $ps
...
# Add legend
gmt psscale -Dg84.0/-20+w11.4c/0.4c+v+o0.3/0i+ml -R -J -Ccolors.cpt \
    --FONT_LABEL=6p,Helvetica,dimgray \
    --FONT_ANNOT_PRIMARY=6p,Helvetica,black \
    -Ba1000f500+l"Color scale 'cyclic': Cyclic colormap, spans 360 degrees of hue [C=HSV] 1/12598)" \
    -I0.2 -By+lm -O -K >> $ps
    
# Add isolines
gmt grdcontour st_sed.nc -R -J -C1000 -Wthinnest,white -O -K >> $ps
