...
gmt makecpt -Croma.cpt -V -T0/6000 > sediments.cpt
# makecpt --help

# Make raster image
# gmt grdimage GEBCO_2019.nc -Cmyocean.cpt -R120/134/-80/-40 -JM6i -P -I+a15+ne0.75 -Xc -K > $ps
grdcut GlobSed-v2.nc -R20/120/-65/30 -Gio_sed.nc
#gmt grdimage io_sed.nc -Csediments.cpt -R20/120/-65/30 -JM6i -P -I+a15+ne0.75 -Xc -K > $ps
#gmt grdimage io_sed.nc -Csediments.cpt -R20/120/-65/30 -JA70/-20/5i -P -I+a15+ne0.75 -Xc -K > $ps
#gmt grdimage io_sed.nc -Csediments.cpt -R20/120/-65/30 -JPoly/5i -P -I+a15+ne0.75 -Xc -K > $ps
#gmt grdimage io_sed.nc -Csediments.cpt -R20/120/-65/30 -JD70/-20/5/-42/5i -P -I+a15+ne0.75 -Xc -K > $ps
gmt grdimage io_sed.nc -Csediments.cpt -R20/120/-65/30 -JQ5.0i -P -I+a15+ne0.75 -Xc -K > $ps
...
gmt psconvert IO_Sediments.ps -A0.5c -E720 -Tj -Z
